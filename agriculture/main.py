...
plot_cpi = get_plot(u'CPI（月）', pct=True)
...
plot_agri_price = get_plot(u'食用农产品价格指数（月）')
plot_agri_price.line('date', 'index', source=source_agri_price, line_width=2, legend=u'食用农产品价格指数')

plot_agri_detail = get_plot(u'食品农产品价格指数分项周环比（周）', pct=True)
