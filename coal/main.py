...
plot_elec = get_plot(u'发电累计耗用原煤增速', pct=True)
plot_elec.line('date', 'coal', source=source_elec, line_width=2, legend=u'发电累计耗用原煤')

plot_steam = get_plot(u'动力煤进出口数量同比', pct=True)
...
plot_cok = get_plot(u'炼焦煤进出口数量同比', pct=True)
