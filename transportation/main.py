...
def update_road():
    ...
    source_road.data = {'date': df.index, 'load': df[dic[u'公路货运量']]}
...
plot_thruput = get_plot(u'沿海主要港口集装箱吞吐量同比', pct=True)
